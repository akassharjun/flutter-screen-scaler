...
class ScreenScaler {
  ...
  static EdgeInsetsGeometry getPaddingByHeight(
    double height,
  ) =>
      EdgeInsets.fromLTRB(
        getHeight(height),
  ...
  static EdgeInsetsGeometry getPaddingByWidth(
    double width,
  ) =>
      EdgeInsets.fromLTRB(
        getHeight(width),
  ...
  static EdgeInsetsGeometry getMarginByHeight(
    double height,
  ) =>
      EdgeInsets.fromLTRB(
        getHeight(height),
  ...
  static EdgeInsetsGeometry getMarginByWidth(
    double width,
  ) =>
      EdgeInsets.fromLTRB(
        getHeight(width),
  ...
  static EdgeInsetsGeometry getMarginLTRB(
    double left,
    double top,
    double right,
    double bottom,
  ...
  static BorderRadius getBorderRadiusCircularLR(
    double topLeft,
    double topRight,
    double bottomLeft,
    double bottomRight,
  ...
  static BorderRadius getBorderRadiusCircularByHeight(
    double radius,
  ) =>
  ...
  static BorderRadius getBorderRadiusCircularByWidth(
    double radius,
  ) =>
      BorderRadius.circular(
        getHeight(radius),
